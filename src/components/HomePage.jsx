...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section id="home" className="hero-section bg-gradient-to-br from-gray-50 via-white to-red-50 py-6 md:py-8 lg:py-12">
        <div className="pedizone-container">
      ...
      {/* Products Section */}
      <section id="products" className="py-8 md:py-10 lg:py-16 bg-white">
        <div className="pedizone-container">
          {/* Section Header */}
      ...
      {/* Solutions Section */}
      <section id="solutions" className="py-8 md:py-10 lg:py-16 bg-gradient-to-br from-gray-50 to-white">
        <div className="pedizone-container">
          {/* Section Header */}
          <div className="text-center mb-6 md:mb-8 lg:mb-10">
      ...
      {/* Blog Section */}
      <section id="blog" className="py-8 md:py-10 lg:py-16 bg-gray-50">
        <div className="pedizone-container">
          {/* Section Header */}
          <div className="text-center mb-6 md:mb-8 lg:mb-10">
      ...
      {/* Contact Section */}
      <section id="contact" className="py-8 md:py-10 lg:py-16 bg-white">
        <div className="pedizone-container">
          {/* Section Header */}
          <div className="text-center mb-6 md:mb-8 lg:mb-10">
