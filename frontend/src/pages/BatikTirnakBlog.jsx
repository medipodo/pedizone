          ...
          <div className="max-w-4xl mx-auto">
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-700 leading-relaxed mb-8">
                Medipodo Ayak Sağlığı ekibi olarak tırnak batmasında cerrahi olmayan, ağrısız ve kalıcı çözümler sunuyoruz. Podolojik yaklaşım; tırnağın yapısını, büyüme açısını ve parmak anatomisini değerlendirerek kişiye özel bir tedavi planı oluşturmayı içerir.
              </p>
            ...
            <section className="mb-12">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gray-50 rounded-xl p-6 border-l-4 border-blue-600">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Duruma göre önce ödem ve enfeksiyon kontrol altına alınır, ardından tel/bant uygulanabilir. Enfeksiyon ciddi ise, önce tıbbi tedavi alınması gerekebilir.
                  </p>
                </div>
